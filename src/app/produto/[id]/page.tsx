...
import type { ProdutosEcommerceDto as ProductDto } from '@/api/generated/mCNSistemas.schemas';
...
export default function ProductDetails({ params }: { params: { id: string } }) {
  ...
  const { data: relatedProducts = [] } = useGetApiProdutoEcommerce({
    empresa: 1,
    destaque: 'S'
  }, {
    swr: {
                ...
                <div className="bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow">
                  ...
                  {relatedProduct.PrecoPromocional > 0 && (
                    <p className="text-sm text-gray-500 line-through">
                      R$ {relatedProduct.Preco?.toFixed(2) || '0.00'}
                    </p>
                  )}
