    ...
    const fetchPedidos = async () => {
      try {
        ...
        const response = await fetch(
          `https://pedidoexternohomolog.mcnsistemas.net.br/api/pedidoecommerce/listar?empresa=0&usuario=${encodeURIComponent(email)}&data_inicio=${formatDate(dataInicio)}&data_fim=${formatDate(dataFim)}`,
          {
            headers: {
