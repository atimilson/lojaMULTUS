          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="space-y-8 text-gray-700">
              <section>
                ...
                <p>
                  Ao acessar o site Multus Comercial, você concorda em cumprir estes termos de serviço, 
              ...
              <section>
                ...
                <p>
                  ...
                  ou software) no site Multus Comercial, apenas para visualização transitória pessoal e 
              ...
              <section>
                ...
                <ul className="list-decimal pl-6 space-y-3">
                  <li>
                    Os materiais no site da Multus Comercial são fornecidos 'como estão'. Não oferecemos 
                    garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras 
                    garantias.
                  </li>
                  <li>
                    Além disso, a Multus Comercial não garante ou faz qualquer representação relativa à 
              ...
              <section>
                ...
                <p>
                  Em nenhum caso a Multus Comercial ou seus fornecedores serão responsáveis por quaisquer 
                  danos decorrentes do uso ou da incapacidade de usar os materiais em nosso site, mesmo 
                  que a Multus Comercial ou um representante autorizado tenha sido notificado oralmente 
              ...
              <section>
                ...
                <p>
                  Os materiais exibidos no site da Multus Comercial podem incluir erros técnicos, 
              ...
              <section>
                ...
                <p>
                  A Multus Comercial não analisou todos os sites vinculados ao seu site e não é 
                  responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não 
                  implica endosso pela Multus Comercial do site. O uso de qualquer site vinculado é por 
              ...
              <section>
                ...
                <p>
                  A Multus Comercial pode revisar estes termos de serviço do site a qualquer momento, 
      ...
      <footer className="bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-4">
          <p className="text-center text-sm text-gray-400">
            © {new Date().getFullYear()} Multus Comercial. Todos os direitos reservados.
          </p>
        </div>
      </footer>
    </div>
